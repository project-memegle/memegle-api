...
public class NoSuchAuthenticationCodeExceptionResponse extends ExceptionResponse {
    ...
    public NoSuchAuthenticationCodeExceptionResponse(ResponseCode responseCode) {
        super(responseCode);
    }

    public NoSuchAuthenticationCodeExceptionResponse(ResponseCode responseCode, String message) {
